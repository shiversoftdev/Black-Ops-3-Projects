...
namespace shiversoft
{
    ...
    public sealed class Grammar : Irony.Parsing.Grammar
    {
        ...
        public readonly KeyTerm kLevel;
        ...
        public Grammar() : base(false)
        {
            ...
            RegisterKeyword(ref kLevel, Constants.LEVEL);
            ...
            variableExpr.Rule = parenVariableExpr | directAccess | call | classCall | spawnClass | NormalIdentifier | kVararg |  kSelf | kLevel | getFunction | localFunction | waittill | isdefined | arrayAccess | checkType | stackDeclaration | incDec | castTo;

            constValue.Rule = StringLiteral | makeArray | makeStruct | NumberLiteral | kTrue | kFalse | kUndefined | hashedString | hashedVariable | kLevel | kSelf | getFunction;
