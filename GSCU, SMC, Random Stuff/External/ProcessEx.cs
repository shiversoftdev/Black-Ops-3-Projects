...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        /// <summary>
        /// Free memory allocated by quickalloc
        /// </summary>
        /// <param name="region"></param>
        /// <returns></returns>
        public bool QuickFree(PointerEx region)
        {
            if(!Handle)
            {
                return false;
            ...
            return VirtualFreeEx(Handle, region, 0, (int)FreeType.Release);
        }
        ...
        /// <summary>
        /// Replace a region at absoluteAddress (numberOfBytes wide) with NOP instructions.
        /// </summary>
        /// <param name="absoluteAddress"></param>
        ...
        public void Suspend()
        {
            NativeStealth.NtSuspendProcess(Handle);
        }
        ...
        public void Resume()
        {
            NativeStealth.NtResumeProcess(Handle);
        }
        #endregion
