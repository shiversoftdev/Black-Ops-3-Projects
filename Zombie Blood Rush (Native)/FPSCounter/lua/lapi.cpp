...
int lua_pcall(lua_State* s, long nargs, long nresults)
{
	...
	lua_pcall_t* f2 = (lua_pcall_t*)(REBASE(0x1D53DB0));
...
void lua_setfield(lua_State* s, int index, const char* k)
{
	...
	auto f = (lua_setfield_t*)(REBASE(0x1429680));
	f(s, index, k);
}
...
const void* lua_topointer(lua_State* s, int index)
{
    ...
    auto f = (lua_topointer_t*)(REBASE(0x1D4EF90));
    return f(s, index);
}
...
int lua_toboolean(lua_State* s, int index)
{
    ...
    auto f = (lua_toboolean_t*)(REBASE(0x14373D0));
    return f(s, index);
}
...
hksUint64 lua_toui64(lua_State* s, int index)
{
    ...
    auto f = (lua_toui64_t*)(REBASE(0x1D4C8A0));
    return f(s, index);
}
...
void lua_pushlstring(lua_State* s, const char* str, size_t l)
{
    ...
    auto f = (lua_pushlstring_t*)(REBASE(0xA18430));
    f(s, str, l);
}
